  ...
  return (
    ...
    >
      ...
      <div className="sr-only" role="status" aria-live="polite">
        {stage === "dark" && "A magical book sits on a dark desk. Move your wand to illuminate it, then tap to open."}
        {stage === "reading" && "The book is open. Navigate through chapters of the love story."}
      </div>
    </main>
  )
}

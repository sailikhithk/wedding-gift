      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, #1a0e05 0%, #2a1a0a 50%, #1a0e05 100%)",
            }}
          >
            {/* Play icon */}
            <div
            ...
            >
              <svg width="32" height="32" viewBox="0 0 24 24" style={{ color: "#c9a84c" }}>
            ...
            <p className="font-serif text-xs mt-4 italic" style={{ color: "rgba(139, 115, 85, 0.6)" }}>
        ...
        <div className="mt-6 text-center">
          ...
          <p className="font-serif text-sm mt-1 italic" style={{ color: "#8b7355" }}>
            {chapter.subtitle}
          </p>
        </div>
      </div>

...
export const chapters: Chapter[] = [
  {
    ...
    storyText:
      "✨ Long before the stars aligned and the universe conspired, two souls wandered separate paths — each unknowing that fate had already written their names together in the great ledger of destiny. 🌟 Like a prophecy whispered through the halls of time, their meeting was inevitable. The moment their eyes met, the magic began — not with a grand explosion, but with a quiet certainty that everything before had been leading to this. 🔮 The stars had been watching, the moon had been waiting, and the ancient magic of the universe had been weaving their story long before they ever knew it. 💫 Every constellation in the sky had spelled out their names, every shooting star had carried their wishes, every sunrise had been painting the canvas of their destiny. 🌙 And when the moment finally arrived — that singular, breathtaking moment — the whole world seemed to hold its breath. ⚡ For this was no ordinary meeting. This was the fulfilment of a prophecy written in the very fabric of time itself. 🦋 Two souls, two paths, one magnificent destiny. The magic had only just begun.",
    videoPlaceholder: "Your first meeting memory",
    gifUrl: "https://media.giphy.com/media/XEDdPba6tD6qR365E6/giphy.gif",
  ...
  },
  {
    ...
    gifUrl: "https://media.giphy.com/media/xUOxeVx2gXMdmkQkiQ/giphy.gif",
  ...
  },
  {
    ...
    gifUrl: "https://media.giphy.com/media/5qFNBm9wF5giwEJIR6/giphy.gif",
  ...
  },
  {
    ...
    gifUrl: "https://media.giphy.com/media/jYzYW16heYmaq1miMh/giphy.gif",
